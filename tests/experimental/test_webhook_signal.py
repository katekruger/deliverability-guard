"""Tests for experimental/webhook_signal.py, including the end-to-end
webhook -> evaluation -> throttle path in dry-run required by Prompt 3's
definition of done (CLOSE3-5: moved here from tests/test_fast_loop.py along
with the module itself -- no production caller wires this up yet)."""
...
from deliverability_guard.experimental.webhook_signal import FastLoopSignal, evaluate_signal
